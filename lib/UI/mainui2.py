...
"""
This may be in competition with ui.py for the main ui module, I think this one is losing.
...
for account in listdir("core/accounts"):
    account_list.append(account.replace(".pkl", ""))
...
class Account_Popup(object):
    ...
    def acceptance(self, Dialog):
        ...
        if not errored:
            typical = Account(typ = typ, bank = self.comboBox.currentText(), savings = self.checkBox.isChecked())
